...
//    }
    ...
    public void createData() {
        ...
        data.mod("2015-05-10", 17, 1, "gwanak", 59, 125);
        createDatum(data);
        data.mod("2015-05-11", 1, 3, "gwanak", 58, 125);
        createDatum(data);
        data.mod("2015-05-12", 4, 5, "gwdaa anak", 59, 125);
        createDatum(data);
        data.mod("2015-05-13", 6, 7, "gwanak", 59, 124);
        createDatum(data);
        data.mod("2015-05-14", 8, 1, "gwanasdak", 59, 124);
        createDatum(data);
        data.mod("2015-05-15", 10, 1, "gwanak", 59, 124);
        createDatum(data);
        data.mod("2015-05-16", 12, 1, "gwaasdnak", 59, 124);
        createDatum(data);
        data.mod("2015-05-17", 1, 1, "gwanak", 59, 125);
        createDatum(data);
        data.mod("2015-05-18", 3, 1, "gwaaa nak", 59, 125);
        createDatum(data);
        data.mod("2015-05-19", 5, 1, "gwanak", 59, 126);
        createDatum(data);
